...
* The tokens from OpenVidu Server.
* When we have our tokens available, the only thing left to do is to give the desired configuration to openvidu-webcomponent. 
* To do so we use an object with three parameters: sessionName, user and tokens.
